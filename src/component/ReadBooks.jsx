...
const ReadBooks = () => {
    ...
    return (
        <div className='flex flex-col gap-4'>
            {
                read.map(v => (
                    <div className='flex flex-col lg:flex-row gap-5 lg:gap-10 border border-gray-300 shadow-xl rounded-2xl p-4 transition duration-300 hover:-translate-y-2 hover:shadow-2xl'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <div className='flex items-center gap-3 flex-wrap'>
                                ...
                                <button onClick={() => setRead(c => c.filter(x => x.bookId !== v.bookId))} className='btn btn-success rounded-full text-white'>Delete</button>
                            </div>
                        </div>
                    </div>
                ))
